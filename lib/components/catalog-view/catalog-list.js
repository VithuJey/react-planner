...
var CatalogList = function (_Component) {
  ...
  _createClass(CatalogList, [{
    ...
    value: function render() {
      ...
      var catalogItems = ["wall", "gate", "text"];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.state.matchString === "" ? [turnBackButton, categoriesToDisplay.map(function (cat) {
            ...
            if (catalogItems.includes(elem.name)) return _react2.default.createElement(_catalogItem2.default, { key: elem.name, element: elem });
