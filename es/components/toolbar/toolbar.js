...
import { MdSettings, MdUndo, MdDirectionsRun, MdAspectRatio } from "react-icons/md";
import { FaFile, FaMousePointer, FaPlus, FaWindowClose } from "react-icons/fa";
...
var Toolbar = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      //     <ToolbarButton
      //       active={false}
      //       // tooltip={translator.t("Close floor planner")}
      //       onClick={(event) =>
      //         confirm(translator.t("Would you want to close floor planner?"))
      ...
      // },
      {
        ...
        dom: React.createElement(
          ...
          React.createElement(MdAspectRatio, null)
        )
      }];
